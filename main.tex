...
\title{Indicators for sanitation quality in low-income urban settlements
...
\thanks{\textbf{Availability of data, code and material:} https://github.com/dariomeili/sanitation-indicators}
}
